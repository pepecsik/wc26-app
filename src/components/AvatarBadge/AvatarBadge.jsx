  ...
  return (
    ...
    >
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.chin} style={{ background: document.documentElement.dataset.theme ? (document.documentElement.dataset.mode === 'light' ? 'rgba(0,0,0,0.08)' : 'rgba(0,0,0,0.6)') : color }}>
